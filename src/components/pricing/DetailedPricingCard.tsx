...
const DetailedPricingCard: React.FC<DetailedPricingCardProps> = ({
  ...
  const onboardingPricing = formatPricing(tier.onboardingFee, true);
          ...
          <div className="space-y-4">
            {tier.basePrice > 0 ? <>
                <div className="text-center">
                  <div className={`text-xl font-bold ${tier.highlighted ? 'text-yellow-400' : 'text-white'}`}>
                    {monthlyPricing.current}
                  </div>
                  <div className="text-gray-500 mt-1">{billingCycle === 'annually' ? 'Per Year' : 'Per Month'}</div>
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-300 text-sm">
                  {tier.name === 'Starter' ? '7 modules included' : 
                   tier.name === 'Decorator' ? '10 modules included' : 
