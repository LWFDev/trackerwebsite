  ...
  return (
    <div className="py-24 bg-gradient-to-t from-zinc-900 to-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div 
          ref={glowRef}
          className="absolute w-[800px] h-[800px] rounded-full bg-[#D4AF37]/5 blur-[100px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2] pointer-events-none"
          style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollReveal threshold={0.1} delay={100} className="max-w-4xl mx-auto">
          <motion.div 
            className="bg-zinc-900/70 backdrop-blur-md border border-zinc-800 rounded-xl p-8 md:p-12 shadow-xl"
          ...
          >
            <div className="text-center mb-10">
              ...
              >
                Need a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F2D675] relative">
                  Custom Solution
                  <motion.div 
                    className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-[#D4AF37] to-[#F2D675]"
                    initial={{ width: 0 }}
            ...
            >
              <motion.div 
                className="bg-zinc-800/50 rounded-lg p-6 text-center"
            ...
            >
              <Link to="/contact">
                <Button 
                  size="lg" 
                  className="font-medium px-8 py-6 text-base bg-gradient-to-r from-[#D4AF37] to-[#F2D675] text-black hover:from-[#F2D675] hover:to-[#D4AF37] group relative overflow-hidden"
                >
