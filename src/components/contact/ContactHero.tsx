      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        {locale === 'US' && (
          <p className="text-sm text-gray-400 max-w-3xl mx-auto mb-10">
            Exclusive US implementation partner - <a href="https://mebuisworks.com/get-demo/?utm_source=tracker&utm_medium=website&utm_campaign=contact_hero" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light transition-colors">MebuisWorks</a>
          </p>
        )}
      </div>
    </div>
