...
const ModuleLayout = ({
  ...
  return <div className="min-h-screen flex flex-col bg-black">
      ...
      {/* Main Section */}
      {mainSection && <section ref={mainRef} className="py-16 bg-black">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center">
                <img src="/lovable-uploads/bd71cf26-6d3f-4aa3-a4e0-d2aa9db5670f.png" alt="Inventory tracking in action" className="max-w-full max-h-[525px] rounded-lg shadow-lg border border-zinc-800 object-contain" />
              </div>
            </div>
