  ...
  return (
    <section className="py-20 bg-zinc-900 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute w-[900px] h-[900px] rounded-full bg-gradient-to-br from-[#D4AF37]/10 via-[#F2D675]/5 to-[#D4AF37]/10 blur-[150px] opacity-60 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        
        {/* Grid pattern */}
        <div className="absolute inset-0 bg-grid-pattern opacity-[0.05]"></div>
        
        {/* Reduced floating elements */}
        <div className="absolute top-20 left-[10%] w-16 h-16 rounded-full border border-[#D4AF37]/10 opacity-30"></div>
        <div className="absolute bottom-20 right-[15%] w-24 h-24 rounded-md border border-[#D4AF37]/10 opacity-20 rotate-45"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollReveal direction="up" distance="40px" duration={900}>
          <div className="max-w-3xl mx-auto relative">
            <div 
              ref={containerRef} 
              className="relative p-10 rounded-2xl bg-zinc-900/70 border border-zinc-800 hover:border-[#D4AF37]/30 transition-all duration-500 shadow-xl overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="inline-block px-4 py-1.5 bg-black/30 rounded-full border border-zinc-700 mb-6">
                ...
                <Link to="/get-started">
                  <Button size="lg" className="group px-8 shadow-xl bg-gradient-to-r from-[#D4AF37] to-[#F2D675] hover:from-[#F2D675] hover:to-[#D4AF37] text-black transform transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
        ...
        {/* Simplified floating statistics badges */}
        <div className="flex flex-wrap justify-center gap-6 mt-12">
          <ScrollReveal delay={300} direction="up" className="bg-zinc-900/80 px-5 py-3 rounded-full border border-zinc-800 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-3 h-3 rounded-full bg-[#D4AF37]/40"></div>
            <span className="text-gray-300 text-sm">1,000+ Active Users</span>
          </ScrollReveal>
          
          <ScrollReveal delay={400} direction="up" className="bg-zinc-900/80 px-5 py-3 rounded-full border border-zinc-800 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-3 h-3 rounded-full bg-[#D4AF37]/40"></div>
            <span className="text-gray-300 text-sm">24/7 Support Available</span>
          </ScrollReveal>
          
          <ScrollReveal delay={500} direction="up" className="bg-zinc-900/80 px-5 py-3 rounded-full border border-zinc-800 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-3 h-3 rounded-full bg-[#D4AF37]/40"></div>
