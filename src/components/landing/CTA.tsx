...
const CTA = () => {
  ...
  return (
    <section className="py-12 md:py-20 bg-gray-800 dark:bg-zinc-900 light:bg-gray-800 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollReveal direction="up" distance="40px" duration={900}>
          <div className="max-w-3xl mx-auto relative">
            <div ref={containerRef} className="relative p-6 sm:p-10 rounded-2xl bg-gray-800/70 dark:bg-zinc-900/70 light:bg-gray-800/70 border border-gray-700 dark:border-zinc-800 light:border-gray-700 hover:border-[#D4AF37]/30 transition-all duration-500 shadow-xl overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 bg-black/30 rounded-full border border-gray-600 dark:border-zinc-700 light:border-gray-600 mb-4 sm:mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-6 mt-8 sm:mt-12">
          <ScrollReveal delay={300} direction="up" className="bg-gray-800/80 dark:bg-zinc-900/80 light:bg-gray-800/80 px-3 sm:px-5 py-2 sm:py-3 rounded-full border border-gray-700 dark:border-zinc-800 light:border-gray-700 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
          ...
          <ScrollReveal delay={400} direction="up" className="bg-gray-800/80 dark:bg-zinc-900/80 light:bg-gray-800/80 px-3 sm:px-5 py-2 sm:py-3 rounded-full border border-gray-700 dark:border-zinc-800 light:border-gray-700 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-[#D4AF37]/40"></div>
            <span className="text-gray-300 text-xs sm:text-sm">24/7 Support Available</span>
          </ScrollReveal>
          
          <ScrollReveal delay={500} direction="up" className="bg-gray-800/80 dark:bg-zinc-900/80 light:bg-gray-800/80 px-3 sm:px-5 py-2 sm:py-3 rounded-full border border-gray-700 dark:border-zinc-800 light:border-gray-700 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-[#D4AF37]/40</div>
            <span className="text-gray-300 text-xs sm:text-sm">99.9% Uptime</span>
          </ScrollReveal>
        </div>
      </div>
    </section>
