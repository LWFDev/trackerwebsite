    ...
    <section className="py-12 md:py-20 bg-zinc-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-3xl mx-auto relative">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 bg-black/30 rounded-full border border-zinc-700 mb-4 sm:mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-6 mt-8 sm:mt-12">
          ...
          <ScrollReveal delay={500} direction="up" className="bg-zinc-900/80 px-3 sm:px-5 py-2 sm:py-3 rounded-full border border-zinc-800 flex items-center gap-2 shadow-lg hover:border-[#D4AF37]/30 transition-all duration-300">
            <div className="w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-[#D4AF37]/40"></div>
