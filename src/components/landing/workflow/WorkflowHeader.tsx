  ...
  return <ScrollReveal direction="down">
      <div className="text-center mb-20 max-w-4xl mx-auto">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in text-gray-900 dark:text-white transition-colors duration-300">
          {t("Transform your")} <span className="text-gold-gradient-animated relative">
            {t("entire workflow")}
            {/* Enhanced underline */}
        ...
        animationDelay: '0.2s'
          ...
          {t("From initial designs to final delivery, Tracker helps you manage every step of your production process with")} <span className="font-semibold text-green-500">{t("unprecedented efficiency")}</span>.
        </p>
      </div>
    </ScrollReveal>;
};
