            ...
            <nav className="p-3 overflow-y-auto max-h-[calc(70vh-140px)]">
              <ul className="space-y-0.5">
                {[
                  ...
                  { to: "/logo-management", label: "Logo Management" },
                  { to: "/production-scheduling", label: "Production Scheduling" },
                  { to: "/proof-approvals", label: "Proof Approvals" },
                  { to: "/videos", label: "Video Guides" },
