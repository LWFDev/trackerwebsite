  ...
  return (
    <ScrollReveal delay={delay} direction="up" className="group">
      <Link to={link} className="block h-full">
        <div className="h-full p-6 bg-gray-50 dark:bg-zinc-900/80 light:bg-white backdrop-blur-sm rounded-xl border border-gray-200 dark:border-zinc-800 light:border-gray-200 transition-all duration-300 hover:border-[#D4AF37]/40 hover:shadow-lg hover:shadow-[#D4AF37]/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white light:text-gray-900 group-hover:text-[#D4AF37] transition-colors duration-300">{title}</h3>
