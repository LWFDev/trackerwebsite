...
const Workflow = () => {
  ...
  return (
    <section className="py-24 bg-gray-50 dark:bg-zinc-900 light:bg-white text-gray-900 dark:text-white light:text-gray-900 relative overflow-hidden transition-colors duration-300">
      <WorkflowBackground />
