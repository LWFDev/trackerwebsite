      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          <div className="md:w-2/3 bg-gray-100 rounded-lg p-6">
            <div className="mb-8">
              <div className="mb-2 text-2xl font-bold text-amber-500">65%</div>
              <div>reduction in design time</div>
            </div>
            <div className="mb-8">
              <div className="mb-2 text-2xl font-bold text-amber-500">3x</div>
              <div>faster client approvals</div>
            </div>
            <div>
              <div className="mb-2 text-2xl font-bold text-amber-500">45%</div>
