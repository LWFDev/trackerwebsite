  ...
  categories: [
    {
      ...
      icon: <img src="/lovable-uploads/e43639fe-8f28-4447-8659-16c1baee9b53.png" alt="Business Operations" className="h-8 w-8" />,
      learnMoreLink: "#business-operations"
    },
    {
      title: "Customer Management",
      description: "Tools for managing customer relationships and service",
      icon: <img src="/lovable-uploads/f888f0f0-5dc9-4944-b5ed-64b239b1e58e.png" alt="Customer Management" className="h-8 w-8" />,
      learnMoreLink: "#customer-management"
    },
    {
      title: "Production & Design",
      description: "Solutions for product design and manufacturing",
      icon: <img src="/lovable-uploads/d42f1f67-bb61-4af4-bf00-41e4dd3055e8.png" alt="Production & Design" className="h-8 w-8" />,
