        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-8 mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-gold-DEFAULT hover:bg-gold-hover text-black px-6">
                Get Started
              </Button>
              <Button size="lg" variant="outline" className="border-gray-600 text-white hover:bg-zinc-800">
                Contact Sales
              </Button>
            </div>
