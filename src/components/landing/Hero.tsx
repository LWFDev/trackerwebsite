...
const Hero = () => {
  return (
    <section className="relative pt-32 md:pt-36 pb-8 md:pb-16 text-gray-900 dark:text-white light:text-gray-900 overflow-hidden transition-colors duration-300">
