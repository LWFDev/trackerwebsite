        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-12 mb-10 md:mb-0">
            ...
            <div className="space-y-5 mb-8">
              <div className="flex items-center p-3 bg-zinc-900/60 backdrop-blur-sm rounded-lg border border-zinc-800 transform transition-all duration-300 hover:border-[#D4AF37]/50 hover:-translate-y-1 hover:shadow-lg animate-fade-in" style={{ animationDelay: '0.3s' }}>
                <CheckCircle className="w-5 h-5 text-[#D4AF37] mr-3" />
                <span>Connect with popular e-commerce platforms</span>
              </div>
              <div className="flex items-center p-3 bg-zinc-900/60 backdrop-blur-sm rounded-lg border border-zinc-800 transform transition-all duration-300 hover:border-[#D4AF37]/50 hover:-translate-y-1 hover:shadow-lg animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <CheckCircle className="w-5 h-5 text-[#D4AF37] mr-3" />
                <span>Sync with your accounting software</span>
              </div>
              <div className="flex items-center p-3 bg-zinc-900/60 backdrop-blur-sm rounded-lg border border-zinc-800 transform transition-all duration-300 hover:border-[#D4AF37]/50 hover:-translate-y-1 hover:shadow-lg animate-fade-in" style={{ animationDelay: '0.5s' }}>
                <CheckCircle className="w-5 h-5 text-[#D4AF37] mr-3" />
                <span>Import designs from Adobe Creative Cloud</span>
              </div>
              <div className="flex items-center p-3 bg-zinc-900/60 backdrop-blur-sm rounded-lg border border-zinc-800 transform transition-all duration-300 hover:border-[#D4AF37]/50 hover:-translate-y-1 hover:shadow-lg animate-fade-in" style={{ animationDelay: '0.6s' }}>
                <CheckCircle className="w-5 h-5 text-[#D4AF37] mr-3" />
