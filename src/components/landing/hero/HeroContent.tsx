...
const StatCard = ({ number, label }: StatCardProps) => {
  return (
    <div className="relative group">
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-4 rounded-lg border border-slate-200/50 dark:border-slate-700/50 hover:border-yellow-400/50 dark:hover:border-yellow-500/50 transition-all duration-300 shadow-sm hover:shadow-md">
