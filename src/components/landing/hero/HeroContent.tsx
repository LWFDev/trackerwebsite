...
const StatCard = ({ number, label }: StatCardProps) => {
  return (
    <div className="relative group">
      ...
      <div className="bg-gray-50 dark:bg-zinc-900/60 light:bg-gray-50 backdrop-blur-sm p-4 rounded-lg border border-gray-200 dark:border-zinc-800 light:border-gray-200 hover:border-[#D4AF37]/50 transition-all duration-300 relative z-10">
