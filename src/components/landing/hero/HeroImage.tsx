      ...
      <div className="relative">
        ...
        {!isMobile && (
          <>
            ...
            <div className="absolute top-10 -right-8 bg-zinc-900/90 backdrop-blur-sm px-2 py-1.5 rounded-lg text-xs font-medium shadow-lg z-30 animate-float border border-lime-400/30 text-white" style={{ animationDelay: '1s' }}>
              <div className="flex items-center gap-1">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-lime-400">
