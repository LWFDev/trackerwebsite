  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute -inset-4 bg-gold-gradient opacity-20 blur-[40px] rounded-full transform group-hover:scale-105 transition-all duration-300"></div>
        ...
        {!isMobile && (
          <>
            ...
            <div className="absolute top-10 -right-8 bg-zinc-900/90 backdrop-blur-sm px-2 py-1.5 rounded-lg text-xs font-medium shadow-lg z-30 animate-float border border-gold-opacity-30 text-white" style={{ animationDelay: '1s' }}>
            ...
            <div className="absolute -left-6 bottom-20 bg-zinc-900/90 backdrop-blur-sm px-4 py-3 rounded-lg font-medium shadow-lg z-30 animate-float border border-gold-opacity-30 text-white" style={{ animationDelay: '1.5s' }}>
        ...
        <div className={`absolute -top-6 -left-6 w-12 h-12 border border-gold-opacity-30 rounded-full animate-spin-slow ${isMobile ? 'hidden sm:block' : ''}`}></div>
        <div className="absolute -bottom-10 left-1/2 w-20 h-1 bg-gradient-to-r from-transparent via-gold-opacity-30 to-transparent rounded-full"></div>
      </div>
    </motion.div>
  );
};
