  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-black to-zinc-900 flex items-center justify-center mb-6 group-hover:shadow-inner shadow-lg transition-all duration-300">
        <Icon className="w-7 h-7 text-gold-DEFAULT group-hover:scale-110 transition-transform duration-300" />
      </div>
      <h3 className="text-xl font-semibold mb-4 group-hover:text-gold-DEFAULT transition-colors duration-300">{title}</h3>
...
const ModuleCard = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-semibold mb-2 group-hover:text-gold-DEFAULT transition-colors duration-300">{title}</h3>
      <p className="text-gray-400 text-sm mb-3 group-hover:text-gray-300 transition-colors duration-300">{description}</p>
      <a href="#" className="text-gold-DEFAULT text-sm font-medium hover:underline inline-flex items-center">
        Learn more 
  ...
  return (
    <section id="features" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute w-[500px] h-[500px] rounded-full bg-gold-DEFAULT/5 blur-[120px] bottom-20 right-10"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <div className="inline-block px-4 py-1.5 bg-zinc-900/80 backdrop-blur-sm rounded-full border border-zinc-800 mb-6">
            <span className="text-sm text-gold-DEFAULT uppercase font-medium tracking-wider">Features</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 animate-fade-in">
            Everything You Need in <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-DEFAULT to-gold-light">One Platform</span>
          </h2>
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <div className="inline-block px-4 py-1.5 bg-zinc-900/80 backdrop-blur-sm rounded-full border border-zinc-800 mb-6">
            <span className="text-sm text-gold-DEFAULT uppercase font-medium tracking-wider">Modules</span>
          </div>
          <h2 className="text-3xl font-bold mb-6 animate-fade-in">
            Modular Solutions for <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-DEFAULT to-gold-light">Every Need</span>
          </h2>
          <p className="text-lg text-gray-400 animate-fade-in" style={{ animationDelay: '0.2s' }}>
