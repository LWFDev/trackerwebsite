  ...
  return (
    <div className="text-center mb-24">
      ...
      <h1 className="text-6xl md:text-8xl font-bold mb-10 leading-tight">
        <span className="bg-gradient-to-r from-slate-800 via-emerald-600 via-green-500 to-slate-700 bg-clip-text text-transparent">
          The Story Continued
        </span>
      </h1>
      <div className="flex justify-center items-center gap-2 mb-10">
        <div className="w-16 h-1 bg-gradient-to-r from-emerald-500 to-green-400 rounded-full"></div>
        <div className="w-3 h-3 bg-gradient-to-br from-emerald-500 to-slate-400 rounded-full"></div>
        <div className="w-16 h-1 bg-gradient-to-r from-green-400 to-slate-500 rounded-full"></div>
      </div>
