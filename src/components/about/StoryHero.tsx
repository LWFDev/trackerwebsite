...
const StoryHero = () => {
  return (
    <div className="text-center mb-20">
      ...
      <ScrollReveal preset="subtle" delay={500}>
        <div className="flex justify-center items-center gap-2 mb-8">
          <div className="w-12 h-0.5 bg-emerald-500 rounded-full animate-draw-line"></div>
          <div className="w-2 h-2 bg-gold rounded-full"></div>
          <div className="w-12 h-0.5 bg-gold rounded-full animate-draw-line"></div>
        </div>
      </ScrollReveal>

      <ScrollReveal preset="enterprise" delay={700}>
