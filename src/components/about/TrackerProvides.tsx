  ...
  return (
    <section className="mb-24">
      <div className="text-center mb-16">
        <Badge variant="outline" className="mb-6 px-6 py-3 text-white border-white/20 bg-white/10 font-medium">
        ...
        <CardContent className="p-12">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <Card className="border-emerald-400/20 bg-emerald-500/10 shadow-sm">
              ...
              <Card className="border-yellow-400/20 bg-yellow-400/10 shadow-sm">
                <CardContent className="p-6">
            ...
            <div className="space-y-4">
              {keyFeatures.map((feature, index) => (
                <Card key={index} className="border-white/10 hover:border-emerald-400/50 hover:shadow-md transition-all group bg-white/5">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-white font-semibold flex-1">{feature.text}</span>
