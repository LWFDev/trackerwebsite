...
import { Palette, CheckCircle, TrendingUp, Clock, Users, BarChart3 } from "lucide-react";

const ScreenPrinting = () => {
  const challenges = [
    "Managing multiple simultaneous orders efficiently",
    "Optimizing workflow between setup and production",
    "Coordinating color matching and quality control",
    "Meeting tight delivery deadlines consistently"
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl theme-text-secondary mb-8 leading-relaxed">
              Optimize your screen printing workflow and improve delivery times. Manage multiple simultaneous orders without confusion while maintaining quality standards.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">
              Screen Printing Industry Challenges
            </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">
            How Tracker Optimizes Screen Printing
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8">
              Proven Results for Screen Printers
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                ...
                <p className="theme-text-secondary">Improvement in On-Time Delivery</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">60%</div>
                <p className="theme-text-secondary">Reduction in Order Confusion</p>
              </div>
            </div>
            <Button asChild size="lg" className="bg-gradient-to-r from-[#D4AF37] to-[#F2D675] text-black hover:opacity-90 font-semibold">
              <Link to="/get-started">Optimize Your Workflow Today</Link>
            </Button>
          </div>
        </div>
      </section>
