...
import { HardHat, CheckCircle, TrendingUp, Clock, Users, BarChart3 } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <HardHat className="w-12 h-12 text-[#D4AF37]" />
            ...
            <p className="text-xl theme-text-secondary mb-8 leading-relaxed">
              Ideal for uniform service companies managing continuous order flow. Ensure timely production, accurate fulfillment, and improved inventory control for all workwear needs.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">
            Professional Solutions with Tracker
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">55%</div>
                <p className="theme-text-secondary">Better Inventory Control</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">99%</div>
                <p className="theme-text-secondary">On-Time Delivery Rate</p>
              </div>
            </div>
            <Button asChild size="lg" className="bg-gradient-to-r from-[#D4AF37] to-[#F2D675] text-black hover:opacity-90 font-semibold">
              <Link to="/get-started">Elevate Your Service</Link>
            </Button>
          </div>
        </div>
      </section>
