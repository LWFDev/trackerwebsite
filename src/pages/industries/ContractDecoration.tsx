...
import { Settings, CheckCircle, TrendingUp, Clock, Users, BarChart3 } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl theme-text-secondary mb-8 leading-relaxed">
              Designed for businesses offering contracted decoration services. Simplify complex workflows by providing full visibility into production stages, client-specific requirements, and deadlines.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">
            Professional Decoration Solutions
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8">
              Contract Service Excellence
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">60%</div>
                <p className="theme-text-secondary">Improvement in Workflow Efficiency</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">45%</div>
                <p className="theme-text-secondary">Reduction in Missed Deadlines</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#D4AF37] mb-2">85%</div>
                <p className="theme-text-secondary">Client Retention Rate</p>
              </div>
            </div>
            <Button asChild size="lg" className="bg-gradient-to-r from-[#D4AF37] to-[#F2D675] text-black hover:opacity-90 font-semibold">
              <Link to="/get-started">Master Your Contracts</Link>
            </Button>
          </div>
        </div>
      </section>
