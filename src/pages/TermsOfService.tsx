      ...
      <div className="container mx-auto px-6 py-16">
            ...
            <div className="lg:col-span-3">
              <div className="prose prose-lg max-w-none">
                ...
                <section id="acceptance" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('1. Acceptance of Terms')}</h2>
                ...
                <section id="description" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('2. Description of Service')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="accounts" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('3. User Accounts & Registration')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="acceptable-use" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('4. Acceptable Use Policy')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="intellectual-property" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('5. Intellectual Property Rights')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="payment" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('6. Payment Terms & Billing')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="privacy" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('7. Data & Privacy')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="availability" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('8. Service Availability & Support')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="liability" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('9. Limitation of Liability')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="termination" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('10. Termination')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="updates" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('11. Updates to Terms')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="contact" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('12. Contact Information')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    {t('If you have any questions about these Terms of Service, please contact us:')}
                  </p>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <p className="text-gray-700 mb-2"><strong>{t('Email:')}</strong> legal@tracker.com</p>
                    <p className="text-gray-700 mb-2"><strong>{t('Phone:')}</strong> +1 (555) 123-4567</p>
                    <p className="text-gray-700"><strong>{t('Address:')}</strong> 123 Business Ave, Suite 100, City, State 12345</p>
                  </div>
                </section>
        ...
        <div className="max-w-4xl mx-auto mt-20">
          <div className="bg-gradient-to-r from-[#f3f4f6] to-[#e5e7eb] rounded-2xl p-12 text-center border border-gray-200">
            ...
            <h3 className="text-3xl font-light text-gray-900 mb-4">{t('Questions about our terms?')}</h3>
