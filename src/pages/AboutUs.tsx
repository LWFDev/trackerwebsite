...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Hero Section */}
      <div className="pt-24 pb-16 bg-[#0066CC] text-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
          <div className="absolute w-[600px] h-[600px] rounded-full bg-[#0078F0]/30 blur-[120px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              <h3 className="text-lg text-[#D4AF37] mb-4">Our Story</h3>
              <h2 className="text-3xl font-bold mb-6">From frustration to innovation</h2>
      ...
      <div className="py-16 bg-zinc-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-lg text-[#D4AF37] mb-4">Our Values</h3>
            <h2 className="text-3xl font-bold mb-6">What drives us every day</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-zinc-800/50 p-6 rounded-lg border border-zinc-700 hover:border-[#D4AF37]/40 transition-all duration-300">
                <div className="mb-4">
                  {value.icon}
                </div>
      ...
      <div className="py-16 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-lg text-[#D4AF37] mb-4">Our Team</h3>
            <h2 className="text-3xl font-bold mb-6">Meet the people behind Tracker</h2>
            <p className="text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {teamMembers.map((member) => (
              <div key={member.id} className="bg-zinc-800/20 rounded-lg overflow-hidden group">
          ...
          <div className="mt-12 text-center">
            <Button variant="outline" className="border-zinc-700 hover:border-[#D4AF37] group">
              Join our team 
              <ArrowUpRight className="ml-2 h-4 w-4 text-gray-400 group-hover:text-[#D4AF37] transition-colors" />
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-zinc-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-lg text-[#D4AF37] mb-4">Testimonials</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="bg-zinc-800/50 p-6 rounded-lg border border-zinc-700">
      ...
      {/* CTA Section */}
      <div className="py-16 bg-[#0066CC] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Join the Tracker community</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Start your free 14-day trial today and see how Tracker can transform your workflow.
          </p>
          <Button variant="default" className="bg-white text-[#0066CC] hover:bg-gray-100">Get Started Free</Button>
        </div>
      </div>
    </div>
  );
