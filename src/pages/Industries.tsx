...
const Industries = () => {
  const industries = [{
    ...
    icon: <Factory className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Palette className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Shirt className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Building2 className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Gift className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Trophy className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <HardHat className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Sparkles className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Monitor className="w-8 h-8 text-gold-DEFAULT" />,
    ...
    icon: <Settings className="w-8 h-8 text-gold-DEFAULT" />,
  ...
  return <div className="min-h-screen theme-background theme-text transition-colors duration-300">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gold-DEFAULT/5 via-transparent to-emerald-500/5"></div>
        <div className="container mx-auto px-4 relative z-10 py-[64px]">
          ...
          duration: 0.6
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-gold-DEFAULT to-gold-light bg-clip-text text-transparent">
              Industry Solutions
            </h1>
            ...
            <Button asChild size="lg" className="bg-gradient-to-r from-gold-DEFAULT to-gold-light text-gold-foreground hover:opacity-90 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industries.map((industry, index) => <ScrollReveal key={index} delay={index * 100}>
                <Link to={industry.link} className="block h-full" onClick={() => window.scrollTo(0, 0)}>
                  <Card className={`h-full theme-surface theme-border hover:border-gold-DEFAULT/50 transition-all duration-300 hover:-translate-y-1 overflow-hidden relative bg-gradient-to-br ${industry.gradient} cursor-pointer`}>
                    ...
                    <CardContent>
                      ...
                      <div className="mt-4 text-gold-DEFAULT font-medium flex items-center gap-1">
                        Learn More
        ...
        <div className="container mx-auto px-4 text-center">
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="border-gold-DEFAULT text-gold-DEFAULT hover:bg-gold-DEFAULT hover:text-gold-foreground">
