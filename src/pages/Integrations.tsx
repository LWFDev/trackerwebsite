...
const partnerIntegrations = [
  { id: "shopify", name: "Shopify", description: "Two-way sync of orders, inventory, and products with your Shopify store. Decoration specs flow into Tracker automatically.", image: "/lovable-uploads/shopify-logo.png", bgColor: "bg-gradient-to-br from-green-500/20 to-green-600/30", category: "E-commerce" },
  { id: "woocommerce", name: "WooCommerce", description: "Connect WooCommerce stores for seamless order import, product sync, and fulfilment status updates.", image: "/lovable-uploads/woocommerce-logo.png", bgColor: "bg-gradient-to-br from-purple-500/20 to-purple-600/30", category: "E-commerce" },
  { id: "shipstation", name: "ShipStation", description: "Automate shipping label creation, carrier selection, and tracking-number pushback to customers.", image: "/lovable-uploads/shipstation-logo.png", bgColor: "bg-gradient-to-br from-blue-500/20 to-blue-600/30", category: "Shipping" },
  { id: "alphabroder", name: "Alphabroder", description: "Real-time blank-garment inventory, pricing, and availability. Auto-create purchase orders when stock runs low.", image: "/lovable-uploads/alphabroder-logo.png", bgColor: "bg-gradient-to-br from-orange-500/20 to-orange-600/30", category: "Distributors" },
  { id: "sanmar", name: "SanMar", description: "Live product catalogue, size/colour matrix, pricing tiers, and stock checks — directly inside Tracker.", image: "/lovable-uploads/sanmar-logo.png", bgColor: "bg-gradient-to-br from-amber-500/20 to-amber-600/30", category: "Distributors" }
];
...
const integrationCategories = [
  {
    ...
    desc: "Barcode-driven file delivery to production equipment for zero-touch logo loading.",
  ...
  },
  {
    ...
    desc: "Pull blank-garment catalogues, live pricing, and inventory directly into Tracker for accurate quoting and purchasing.",
  ...
  },
  {
    ...
    desc: "Sync orders from online stores into Tracker's production pipeline. Push fulfilment status and tracking numbers back to the store.",
  ...
  },
  {
    ...
    desc: "Bi-directional data flow between Tracker and your financial systems — invoices, payments, cost of goods, and general-ledger postings.",
  ...
  },
  {
    ...
    desc: "Rate-shop, print labels, and push tracking numbers — all from within Tracker.",
  ...
  },
  {
    ...
    desc: "Build custom integrations with Tracker's RESTful API and real-time webhook event system.",
    ...
    <>
      <PageSEO
        seo={{
          ...
          description: "Connect Tracker with Barudan, Tajima, SanMar, alphabroder, Shopify, ShipStation, SAP, QuickBooks & more. PLM, machine, ERP & e-commerce integrations for garment decorators.",
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                From embroidery machines and blank-garment distributors to e-commerce stores, ERP platforms, and shipping carriers — Tracker integrates with the tools garment decorators depend on every day. Eliminate double-entry, synchronise data in real time, and run your entire operation from one platform.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <Link key={integration.id} to={`/integrations/${integration.id}`} onClick={scrollToTop} className="group">
                    <div className="bg-card border border-border rounded-xl p-6 h-full transition-all duration-300 hover:border-gold/50 hover:shadow-lg hover:-translate-y-1">
                      <div className={`${integration.bgColor} rounded-lg h-24 flex items-center justify-center mb-6`}>
                        <img src={integration.image} alt={integration.name} className="h-10 w-auto object-contain opacity-90 group-hover:opacity-100 transition-opacity" />
                      </div>
          ...
          <section className="py-20 px-4 bg-muted/30">
            <div className="container mx-auto max-w-6xl">
              ...
              <p className="text-center text-muted-foreground max-w-3xl mx-auto mb-12">
                Tracker connects to every layer of your garment decoration operation — from the machines on your production floor to the accounting software in your back office.
              </p>
          ...
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-6xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { to: "/logo-management", title: "Cloud Logo Management", desc: "Machine-ready logo delivery powered by integrations." },
                  { to: "/production-scheduling", title: "Production Scheduling", desc: "Barcode-to-machine pushes via integrated equipment." },
                  { to: "/proof-approvals", title: "Digital Proof Approvals", desc: "Customer-facing proofs linked to e-commerce orders." }
                ].map((link, i) => (
        ...
        <section className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto max-w-3xl text-center">
            ...
            <p className="text-muted-foreground mb-8">We're constantly adding new connections. Tell us what you need and our team will assess feasibility — often within 48 hours.</p>
