      ...
      <div className="container mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('Table of Contents')}</h2>
                <nav className="space-y-2">
                  {sections.map((section) => (
                    <a
                      key={section.id}
                      href={`#${section.id}`}
                      className="block text-sm text-gray-600 hover:text-[#0176d3] transition-colors py-1"
                    >
                      {section.title}
                    </a>
                  ))}
            ...
            <div className="lg:col-span-3">
              <div className="prose prose-lg max-w-none">
                ...
                <section id="information-collection" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('1. Information We Collect')}</h2>
                ...
                <section id="information-use" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('2. How We Use Your Information')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="information-sharing" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('3. Information Sharing & Disclosure')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="data-security" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('4. Data Security')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="data-retention" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('5. Data Retention')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="your-rights" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('6. Your Rights & Choices')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="international-transfers" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('7. International Data Transfers')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="cookies" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('8. Cookies & Tracking Technologies')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="childrens-privacy" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('9. Children\'s Privacy')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="policy-updates" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('10. Updates to Policy')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section id="contact-us" className="mb-12">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('11. Contact Us')}</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    {t('If you have any questions about this Privacy Policy or our data practices, please contact us:')}
                  </p>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <p className="text-gray-700 mb-2"><strong>{t('Privacy Officer:')}</strong> privacy@tracker.com</p>
                    <p className="text-gray-700 mb-2"><strong>{t('Phone:')}</strong> +1 (555) 123-4567</p>
                    <p className="text-gray-700 mb-2"><strong>{t('Address:')}</strong> 123 Business Ave, Suite 100, City, State 12345</p>
                    <p className="text-gray-700"><strong>{t('Data Protection Representative (EU):')}</strong> eu-privacy@tracker.com</p>
                  </div>
                </section>
        ...
        <div className="max-w-4xl mx-auto mt-20">
          <div className="bg-gradient-to-r from-[#f3f4f6] to-[#e5e7eb] rounded-2xl p-12 text-center border border-gray-200">
            ...
            <h3 className="text-3xl font-light text-gray-900 mb-4">{t('Questions about your privacy?')}</h3>
