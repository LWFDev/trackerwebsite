  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-playfair font-bold mb-8 text-white">Privacy Policy</h1>
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-gray-300 mb-4">
            At Track My Business, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">2. The Data We Collect About You</h2>
          <p className="text-gray-300 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">3. How We Use Your Personal Data</h2>
          <p className="text-gray-300 mb-4">
